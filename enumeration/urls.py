...
urlpatterns = [
    ...
    re_path(r'^all-applications/$', views.AllApplicationList.as_view(), name='application_list'),
    ...
    re_path(r'applications/(?P<pk>\d+)/update/$', views.StatusUpdate.as_view(), name='status-update'),
]
